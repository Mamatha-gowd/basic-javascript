...
const areSameLength = (str1, str2) => {
  ...
  console.log(areSameLength("two","three"));
const areEqual = (x, y) => {
...
console.log(lessThanNinety(100));
...
console.log(combineNames("prashant","pandey"));
